...
class Parser:
    ...
    def __init__(
        ...
        manager.load_images()
        if init_type == "sfm" or init_type == "SfM":
            print("initializing with sfm")
            manager.load_points3D()
        if init_type == "DA3" or init_type == "DA-3":
            print("initializing with DA3")
            manager.load_points3D_bis(input_file= data_dir, init_sampling_size=0.6)
        #manager.display(bis_output=output, green_and_red=True)
