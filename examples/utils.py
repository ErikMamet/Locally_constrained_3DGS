...
def set_random_seed(seed: int):
    ...
    try:
        torch.cuda.manual_seed_all(seed)  # you're missing this
        print("1 torch.cuda.manual_seed_all(seed) ")
    except AttributeError:
        print("Warning: torch.cuda.manual_seed_all is not available. CUDA random seed not set.")
        pass
    try:
        torch.backends.cudnn.deterministic = True
        print("2torch.backends.cudnn.deterministic = True")
    except AttributeError:
        print("Warning: torch.backends.cudnn.deterministic is not available. CUDNN deterministic mode not set.")
        pass
    try:
        torch.backends.cudnn.benchmark = False
        print("3torch.backends.cudnn.benchmark = False")
    except AttributeError:
        print("Warning: torch.backends.cudnn.benchmark is not available. CUDNN benchmark mode not set.")
        pass
